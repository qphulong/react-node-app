...
const ChangePassword = () => {
  ...
  const handleClickChangePassword = async () => {
    ...
    try {
      const response = await axios.put(window.backendURL + `/user/password`, {
  ...
  const handleChangeSocialLink = async () => {
    ...
    try {
      const response = await axios.put(
        window.backendURL + `/user/social-media`,
        {
          userId: currentUser.userId,
          link: socialLink,
        }
    ...
    <div className="container">
      ...
      <div className="change-social-link">
        ...
        <div className="change-social-link-container">
          ...
          <div>
            <button className="change-button" onClick={handleChangeSocialLink}>
              Add social link
            </button>
          </div>
        </div>
