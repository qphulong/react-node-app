...
const Friends = () => {
  ...
  const responseData = async (friendIdPro) => {
    try {
      const res = await axios.delete(window.backendURL + "/user/friends", {
  ...
  //     mutationFn: (friendId) => {
  //     return axios.delete(window.backendURL + `/user/friends`,{
  ...
  const fetchProfileImage = async (id) => {
    try {
      const response = await axios.get(
        window.backendURL + `/user/profile-pic/${id}`
      );
          ...
          FriendsInfo.friends.map((friend) => (
            <div className="item" key={friend.userId}>
              ...
              <div className="friends-mid">
                ...
                <div
                  className="dropdown"
                  ref={(ref) => (dropdownRefs.current[friend.userId] = ref)}
                >
